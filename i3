...
font pango:Overpass Semibold 10
...
mode "resize" {
        ...
        bindsym lresize grow width 10 px or 10 ppt
...
# Background
exec_always --no-startup-id feh --bg-scale /home/chris/Pictures/bg9.png
...
# rofi
bindsym $mod+d exec rofi -show run -lines 5 -eh 2 -font "Terminus 12"
